...
if __name__ == "__main__":
    ...
    print(
        "started collecting PSM 1&2 baselink, stereo image, and segmentation image ..."
    )
    ...
    SEGMENT_L = message_filters.Subscriber(
        "/ambf/env/cameras/segmentation_cameraL/ImageData", Image
    )
    SEGMENT_R = message_filters.Subscriber(
        "/ambf/env/cameras/segmentation_cameraR/ImageData", Image
    )

    # create approximate time synchronizer
    ts = message_filters.ApproximateTimeSynchronizer(
        [PSM_1, PSM_2, STEREO_L, STEREO_R, SEGMENT_L, SEGMENT_R],
        queue_size=10,
        slop=0.2,
